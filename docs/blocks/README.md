...
| [BLOCK-07](BLOCK-07-hosting-tier.md) | Hosting: one blind always-on node carrying many people's spaces, backed up to R2, paid through Stripe. Built; metering, quotas, load test and BTCPay left | ~1 week left |
